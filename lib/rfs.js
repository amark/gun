function Store(opt){
	...
	store.put = function(file, data, cb){
		...
		try {
			fs.writeFileSync(opt.file+'-'+random+'.tmp', data)
		} catch (e) {
	...
	store.get = function(file, cb){
		/*store.counter++;
		store.countCall++;
		console.log('readso: ', store.counter, store.countCall);*/
		var err = u;
		try {
			var data = fs.readFileSync(opt.file+'/'+file);
		...
		/*store.counter--;
		console.log('readse: ', store.counter, store.countCall);*/
		cb(err, data);
		/*
