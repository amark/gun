...
var yson = {}, u, sI = Gun.__utils__.setTimeoutTurn || (typeof setImmediate != ''+u && setImmediate) || setTimeout;
...
if(typeof JSON != ''+u){
	Gun.__utils__.parseAsync = yson.parseAsync;
	Gun.__utils__.stringifyAsync = yson.stringifyAsync;
}
