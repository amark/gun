...
Gun.on('create', function(root){
    ...
    root.on('get', function(msg){
        ...
        rad(key||'', function(err, data, o){
            ...
            Gun.log(S, +new Date - S, 'got'); S = +new Date; // MARK RETURN HERE!!!! Gun.log will always log unless off :/ switch to something like LOG && whatever?
            if(data){
            ...
            Gun.log(S, +new Date - S, 'got prep');
            root.on('in', {'@': id, put: graph, '%': o.more? 1 : u, err: err? err : u, _: each});
        }, o);
        Gun.log(S, +new Date - S, 'get call');
