...
Gun.on('opt', function(ctx){
	...
	ctx.on('put', function(at){
		this.to.next(at);
		// TODO: Add Optimization - If a peer is empty,
		// the reply from storage causes a diff,
		// which gets sent back to storage.
		// By adding a meta function to our reply
		// we can detect our own response
		// and safely ignore.
