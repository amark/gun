;(function(){
	...
	function Radisk(opt){
		...
		var map = Gun.obj.map;
		var LOG = !!((typeof opt.debug === 'undefined' || opt.debug === null) ? Gun.log.LOG : opt.debug);
		...
		*/
		...
		r.thrash = function(){
			...
			LOG = !!((typeof opt.debug === 'undefined' || opt.debug === null) ? Gun.log.LOG : opt.debug); // dirty place to cheaply update LOG settings over time.
			thrash.more = false;
			thrash.ing = true;
