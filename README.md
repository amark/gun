...
GUN is a realtime, distributed, offline-first, graph database engine. Doing [**25M+**](https://github.com/amark/gun/wiki/100000-ops-sec-in-IE6-on-2GB-Atom-CPU) ops/sec and just **~12KB** gzipped.
